...
const HeroSection = () => {
  ...
  const featuredArticles = newsItems.filter(item => item.trending).slice(0, 5);
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 tracking-tight">
              ...
              >passes</motion.span> the vibe check
            </h1>
            <p className="text-lg text-muted-foreground mb-6">
              Stay informed without the boring stuff. Get your daily dose of news, trends, and hot takes - all with that Gen Z flavor.
            </p>
            ...
            <div className="mt-8 flex items-center">
              ...
              >
                ...
                </motion.span> Gen Z readers joined today
              </motion.p>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
                      ...
                      <Link to={`/article/${article.id}`}>
                        <div className="group rounded-2xl overflow-hidden hover:shadow-lg transition-shadow relative">
                          ...
                          <div className="absolute bottom-0 left-0 p-6">
                            ...
                            <p className="text-white/80 line-clamp-2 mb-2">{article.summary}</p>
              ...
              >
                ...
                <div>
                  <p className="text-xs font-medium">Trending now</p>
                  <p className="text-xs text-muted-foreground">+2.5k reactions</p>
                </div>
              </motion.div>
