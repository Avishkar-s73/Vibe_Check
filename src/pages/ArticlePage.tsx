...
import { Share2, ArrowLeft, MessageSquare, BookmarkPlus, ThumbsUp, ThumbsDown, Crown, Send } from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {new Date(article.publishDate).toLocaleDateString()} • {article.readTime} min read
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                <motion.button
                  className={`p-2 rounded-full ${isBookmarked ? 'bg-primary text-white' : 'bg-muted'}`}
          ...
          >
            <Tabs defaultValue="article" className="w-full">
              <TabsList className="mb-6">
                <TabsTrigger value="article" className="data-[state=active]:bg-primary data-[state=active]:text-white">Article</TabsTrigger>
                <TabsTrigger value="comments" className="data-[state=active]:bg-primary data-[state=active]:text-white">Comments</TabsTrigger>
                <TabsTrigger value="related" className="data-[state=active]:bg-primary data-[state=active]:text-white">Related</TabsTrigger>
              </TabsList>
